...
| 2026-05-07 | 1.0 | First change | 박찬승 |
...
| SettingsManager | 사용자 설정(단축키, 오버레이 위치 등)을 저장하고 관리하는 클래스 |
...
| 용어 | 설명 |
|-----|-----|
| OCR | 이미지에서 텍스트를 추출하는 기술 |
| Overlay | 화면 위에 겹쳐 표시되는 UI |
| API | 외부 서비스와 통신하는 인터페이스 |
| Hotkey | 특정 기능을 실행하기 위한 단축키 |
